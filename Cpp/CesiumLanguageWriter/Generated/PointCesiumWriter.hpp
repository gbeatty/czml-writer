...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class PointCesiumWriter : CesiumPropertyWriter<PointCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string PixelSizePropertyName = "pixelSize";
        ...
        private:
            ...
            const DoubleCesiumWriter m_pixelSize = DoubleCesiumWriter(PixelSizePropertyName);
        ...
        public:
            ...
            /// </summary>
            PointCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            PointCesiumWriter(const PointCesiumWriter& existingInstance)
