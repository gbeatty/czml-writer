...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class EllipseCesiumWriter : CesiumPropertyWriter<EllipseCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string SemiMajorAxisPropertyName = "semiMajorAxis";

            /// <summary>
            /// The name of the <code>semiMinorAxis</code> property.
            /// </summary>
            const std::string SemiMinorAxisPropertyName = "semiMinorAxis";
            ...
            /// </summary>
            const std::string HeightPropertyName = "height";

            /// <summary>
            /// The name of the <code>extrudedHeight</code> property.
            /// </summary>
            const std::string ExtrudedHeightPropertyName = "extrudedHeight";

            /// <summary>
            /// The name of the <code>granularity</code> property.
            /// </summary>
            const std::string GranularityPropertyName = "granularity";

            /// <summary>
            /// The name of the <code>stRotation</code> property.
            /// </summary>
            const std::string StRotationPropertyName = "stRotation";
            ...
            /// </summary>
            const std::string NumberOfVerticalLinesPropertyName = "numberOfVerticalLines";

        private:
            const BooleanCesiumWriter m_show = BooleanCesiumWriter(ShowPropertyName);
            const DoubleCesiumWriter m_semiMajorAxis = DoubleCesiumWriter(SemiMajorAxisPropertyName);
            const DoubleCesiumWriter m_semiMinorAxis = DoubleCesiumWriter(SemiMinorAxisPropertyName);
            ...
            const DoubleCesiumWriter m_height = DoubleCesiumWriter(HeightPropertyName);
            const DoubleCesiumWriter m_extrudedHeight = DoubleCesiumWriter(ExtrudedHeightPropertyName);
            const DoubleCesiumWriter m_granularity = DoubleCesiumWriter(GranularityPropertyName);
            const DoubleCesiumWriter m_stRotation = DoubleCesiumWriter(StRotationPropertyName);
            ...
            const DoubleCesiumWriter m_numberOfVerticalLines = DoubleCesiumWriter(NumberOfVerticalLinesPropertyName);

        public:
            /// <summary>
            /// Initializes a new instance.
            /// </summary>
            EllipseCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            EllipseCesiumWriter(const EllipseCesiumWriter& existingInstance)
