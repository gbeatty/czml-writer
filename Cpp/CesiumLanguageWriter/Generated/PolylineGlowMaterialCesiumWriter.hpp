...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class PolylineGlowMaterialCesiumWriter : CesiumPropertyWriter<PolylineGlowMaterialCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string GlowPowerPropertyName = "glowPower";

        private:
            const ColorCesiumWriter m_color = ColorCesiumWriter(ColorPropertyName);
            const DoubleCesiumWriter m_glowPower = DoubleCesiumWriter(GlowPowerPropertyName);

        public:
            /// <summary>
            /// Initializes a new instance.
            /// </summary>
            PolylineGlowMaterialCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            PolylineGlowMaterialCesiumWriter(const PolylineGlowMaterialCesiumWriter& existingInstance)
