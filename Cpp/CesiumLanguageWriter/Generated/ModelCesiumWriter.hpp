...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class ModelCesiumWriter : CesiumPropertyWriter<ModelCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string MinimumPixelSizePropertyName = "minimumPixelSize";

            /// <summary>
            /// The name of the <code>gltf</code> property.
            /// </summary>
            const std::string GltfPropertyName = "gltf";
        ...
        private:
            ...
            const DoubleCesiumWriter m_minimumPixelSize = DoubleCesiumWriter(MinimumPixelSizePropertyName);
            const UriCesiumWriter m_gltf = UriCesiumWriter(GltfPropertyName);

        public:
            /// <summary>
            /// Initializes a new instance.
            /// </summary>
            ModelCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            ModelCesiumWriter(const ModelCesiumWriter& existingInstance)
