...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class EyeOffsetCesiumWriter : CesiumInterpolatablePropertyWriter<EyeOffsetCesiumWriter>
    {
        public:
            /// <summary>
        ...
        public:
            ...
            /// </summary>
            EyeOffsetCesiumWriter(string propertyName)
                : base(propertyName)
            {
            ...
            EyeOffsetCesiumWriter(const EyeOffsetCesiumWriter& existingInstance)
