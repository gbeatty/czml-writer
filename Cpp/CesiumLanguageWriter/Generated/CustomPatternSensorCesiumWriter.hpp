...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class CustomPatternSensorCesiumWriter : CesiumPropertyWriter<CustomPatternSensorCesiumWriter>
    {
        public:
            /// <summary>
        ...
        public:
            ...
            /// </summary>
            CustomPatternSensorCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            CustomPatternSensorCesiumWriter(const CustomPatternSensorCesiumWriter& existingInstance)
