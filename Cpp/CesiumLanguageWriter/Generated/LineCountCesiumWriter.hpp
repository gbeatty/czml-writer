...
{
    /// <summary>
    /// Writes a <code>LineCount</code> to a <see cref="CesiumOutputStream" />.  A <code>LineCount</code> the number of grid lines along each axis.
    /// </summary>
    class LineCountCesiumWriter : CesiumInterpolatablePropertyWriter<LineCountCesiumWriter>
    {
        public:
            /// <summary>
        ...
        public:
            ...
            /// </summary>
            LineCountCesiumWriter(string propertyName)
                : base(propertyName)
            {
            ...
            LineCountCesiumWriter(const LineCountCesiumWriter& existingInstance)
        ...
        {
            return new CesiumInterpolatableWriterAdaptor<LineCountCesiumWriter, Rectangular>(
                this, (me, value) => me.WriteCartesian2(value), (LineCountCesiumWriter me, IList<JulianDate> dates, IList<Rectangular> values, int startIndex, int length) => me.WriteCartesian2(dates, values, startIndex, length));
        }
        ...
        {
            return new CesiumWriterAdaptor<LineCountCesiumWriter, Reference>(
