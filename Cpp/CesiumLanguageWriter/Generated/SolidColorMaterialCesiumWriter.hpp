...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class SolidColorMaterialCesiumWriter : CesiumPropertyWriter<SolidColorMaterialCesiumWriter>
    {
        public:
            /// <summary>
        ...
        public:
            ...
            /// </summary>
            SolidColorMaterialCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            SolidColorMaterialCesiumWriter(const SolidColorMaterialCesiumWriter& existingInstance)
