...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class RepeatCesiumWriter : CesiumInterpolatablePropertyWriter<RepeatCesiumWriter>
    {
        public:
            /// <summary>
        ...
        public:
            ...
            /// </summary>
            RepeatCesiumWriter(string propertyName)
                : base(propertyName)
            {
            ...
            RepeatCesiumWriter(const RepeatCesiumWriter& existingInstance)
