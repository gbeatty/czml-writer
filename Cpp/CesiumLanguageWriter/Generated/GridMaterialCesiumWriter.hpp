...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class GridMaterialCesiumWriter : CesiumPropertyWriter<GridMaterialCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string CellAlphaPropertyName = "cellAlpha";

            /// <summary>
            /// The name of the <code>lineCount</code> property.
            /// </summary>
            const std::string LineCountPropertyName = "lineCount";

            /// <summary>
            /// The name of the <code>lineThickness</code> property.
            /// </summary>
            const std::string LineThicknessPropertyName = "lineThickness";

            /// <summary>
            /// The name of the <code>lineOffset</code> property.
            /// </summary>
            const std::string LineOffsetPropertyName = "lineOffset";

        private:
            const ColorCesiumWriter m_color = ColorCesiumWriter(ColorPropertyName);
            const DoubleCesiumWriter m_cellAlpha = DoubleCesiumWriter(CellAlphaPropertyName);
            const LineCountCesiumWriter m_lineCount = LineCountCesiumWriter(LineCountPropertyName);
            const LineThicknessCesiumWriter m_lineThickness = LineThicknessCesiumWriter(LineThicknessPropertyName);
            const LineOffsetCesiumWriter m_lineOffset = LineOffsetCesiumWriter(LineOffsetPropertyName);

        public:
            /// <summary>
            /// Initializes a new instance.
            /// </summary>
            GridMaterialCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            GridMaterialCesiumWriter(const GridMaterialCesiumWriter& existingInstance)
