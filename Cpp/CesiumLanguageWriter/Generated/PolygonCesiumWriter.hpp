...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class PolygonCesiumWriter : CesiumPropertyWriter<PolygonCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string PerPositionHeightPropertyName = "perPositionHeight";
        ...
        private:
            ...
            const BooleanCesiumWriter m_perPositionHeight = BooleanCesiumWriter(PerPositionHeightPropertyName);

        public:
            /// <summary>
            /// Initializes a new instance.
            /// </summary>
            PolygonCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            PolygonCesiumWriter(const PolygonCesiumWriter& existingInstance)
