...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class PositionCesiumWriter : CesiumInterpolatablePropertyWriter<PositionCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string CartesianVelocityPropertyName = "cartesianVelocity";
        ...
        private:
            ...
            const ICesiumInterpolatableValuePropertyWriter<Cartographic> m_asCartographicRadians;
            const ICesiumInterpolatableValuePropertyWriter<Cartographic> m_asCartographicDegrees;
            const ICesiumInterpolatableValuePropertyWriter<Motion<Cartesian>> m_asCartesianVelocity;
        ...
        public:
            ...
            /// </summary>
            PositionCesiumWriter(string propertyName)
                : base(propertyName)
            {
                m_asCartesian = ICesiumInterpolatableValuePropertyWriter<Cartesian>(CreateCartesianAdaptor, false);
                m_asCartographicRadians = ICesiumInterpolatableValuePropertyWriter<Cartographic>(CreateCartographicRadiansAdaptor, false);
                m_asCartographicDegrees = ICesiumInterpolatableValuePropertyWriter<Cartographic>(CreateCartographicDegreesAdaptor, false);
                m_asCartesianVelocity = ICesiumInterpolatableValuePropertyWriter<Motion<Cartesian>>(CreateCartesianVelocityAdaptor, false);
            ...
            PositionCesiumWriter(const PositionCesiumWriter& existingInstance)
