...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class OrientationCesiumWriter : CesiumInterpolatablePropertyWriter<OrientationCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string UnitQuaternionPropertyName = "unitQuaternion";
        ...
        private:
            const ICesiumInterpolatableValuePropertyWriter<UnitQuaternion> m_asUnitQuaternion;
        ...
        public:
            ...
            /// </summary>
            OrientationCesiumWriter(string propertyName)
                : base(propertyName)
            {
                m_asUnitQuaternion = ICesiumInterpolatableValuePropertyWriter<UnitQuaternion>(CreateUnitQuaternionAdaptor, false);
            ...
            OrientationCesiumWriter(const OrientationCesiumWriter& existingInstance)
