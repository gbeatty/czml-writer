...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class PathCesiumWriter : CesiumPropertyWriter<PathCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string ResolutionPropertyName = "resolution";

            /// <summary>
            /// The name of the <code>leadTime</code> property.
            /// </summary>
            const std::string LeadTimePropertyName = "leadTime";

            /// <summary>
            /// The name of the <code>trailTime</code> property.
            /// </summary>
            const std::string TrailTimePropertyName = "trailTime";
        ...
        private:
            ...
            const DoubleCesiumWriter m_resolution = DoubleCesiumWriter(ResolutionPropertyName);
            const DoubleCesiumWriter m_leadTime = DoubleCesiumWriter(LeadTimePropertyName);
            const DoubleCesiumWriter m_trailTime = DoubleCesiumWriter(TrailTimePropertyName);

        public:
            /// <summary>
            /// Initializes a new instance.
            /// </summary>
            PathCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            PathCesiumWriter(const PathCesiumWriter& existingInstance)
