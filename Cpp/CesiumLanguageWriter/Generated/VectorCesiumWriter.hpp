...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class VectorCesiumWriter : CesiumPropertyWriter<VectorCesiumWriter>
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string DirectionPropertyName = "direction";

            /// <summary>
            /// The name of the <code>length</code> property.
            /// </summary>
            const std::string LengthPropertyName = "length";

            /// <summary>
            /// The name of the <code>minimumLengthInPixels</code> property.
            /// </summary>
            const std::string MinimumLengthInPixelsPropertyName = "minimumLengthInPixels";
        ...
        private:
            ...
            const DirectionCesiumWriter m_direction = DirectionCesiumWriter(DirectionPropertyName);
            const DoubleCesiumWriter m_length = DoubleCesiumWriter(LengthPropertyName);
            const DoubleCesiumWriter m_minimumLengthInPixels = DoubleCesiumWriter(MinimumLengthInPixelsPropertyName);

        public:
            /// <summary>
            /// Initializes a new instance.
            /// </summary>
            VectorCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            VectorCesiumWriter(const VectorCesiumWriter& existingInstance)
