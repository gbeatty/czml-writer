...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class EllipsoidRadiiCesiumWriter : CesiumInterpolatablePropertyWriter<EllipsoidRadiiCesiumWriter>
    {
        public:
            /// <summary>
        ...
        public:
            ...
            /// </summary>
            EllipsoidRadiiCesiumWriter(string propertyName)
                : base(propertyName)
            {
            ...
            EllipsoidRadiiCesiumWriter(const EllipsoidRadiiCesiumWriter& existingInstance)
        ...
        {
            return new CesiumWriterAdaptor<EllipsoidRadiiCesiumWriter, Reference>(
