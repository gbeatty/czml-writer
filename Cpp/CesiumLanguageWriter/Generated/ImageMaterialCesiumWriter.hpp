...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class ImageMaterialCesiumWriter : CesiumPropertyWriter<ImageMaterialCesiumWriter>
    {
        public:
            /// <summary>
        ...
        private:
            ...
            const RepeatCesiumWriter m_repeat = RepeatCesiumWriter(RepeatPropertyName);

        public:
            /// <summary>
            /// Initializes a new instance.
            /// </summary>
            ImageMaterialCesiumWriter(string propertyName)
                : base(propertyName)
            {
            }
            ...
            ImageMaterialCesiumWriter(const ImageMaterialCesiumWriter& existingInstance)
