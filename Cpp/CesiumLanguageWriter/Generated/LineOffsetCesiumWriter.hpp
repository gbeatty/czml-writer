...
{
    /// <summary>
    /// Writes a <code>LineOffset</code> to a <see cref="CesiumOutputStream" />.  A <code>LineOffset</code> the offset of grid lines along each axis, as a percentage from 0 to 1.
    /// </summary>
    class LineOffsetCesiumWriter : CesiumInterpolatablePropertyWriter<LineOffsetCesiumWriter>
    {
        public:
            /// <summary>
        ...
        public:
            ...
            /// </summary>
            LineOffsetCesiumWriter(string propertyName)
                : base(propertyName)
            {
            ...
            LineOffsetCesiumWriter(const LineOffsetCesiumWriter& existingInstance)
        ...
        /// <summary>
        /// Writes the <code>cartesian2</code> property.  The <code>cartesian2</code> property specifies the offset of grid lines along each axis, as a percentage from 0 to 1.
        /// </summary>
        ...
        {
            return new CesiumInterpolatableWriterAdaptor<LineOffsetCesiumWriter, Rectangular>(
                this, (me, value) => me.WriteCartesian2(value), (LineOffsetCesiumWriter me, IList<JulianDate> dates, IList<Rectangular> values, int startIndex, int length) => me.WriteCartesian2(dates, values, startIndex, length));
        }
        ...
        {
            return new CesiumWriterAdaptor<LineOffsetCesiumWriter, Reference>(
