...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class PacketCesiumWriter : public CesiumElementWriter
    {
        public:
            /// <summary>
            ...
            /// </summary>
            const std::string ParentPropertyName = "parent";
            ...
            /// </summary>
            const std::string AvailabilityPropertyName = "availability";

            /// <summary>
            /// The name of the <code>position</code> property.
            /// </summary>
            const std::string PositionPropertyName = "position";

            /// <summary>
            /// The name of the <code>billboard</code> property.
            /// </summary>
            const std::string BillboardPropertyName = "billboard";
            ...
            /// </summary>
            const std::string PointPropertyName = "point";

            /// <summary>
            /// The name of the <code>label</code> property.
            /// </summary>
            const std::string LabelPropertyName = "label";

            /// <summary>
            /// The name of the <code>polyline</code> property.
            /// </summary>
            const std::string PolylinePropertyName = "polyline";

            /// <summary>
            /// The name of the <code>path</code> property.
            /// </summary>
            const std::string PathPropertyName = "path";

            /// <summary>
            /// The name of the <code>polygon</code> property.
            /// </summary>
            const std::string PolygonPropertyName = "polygon";

            /// <summary>
            /// The name of the <code>ellipsoid</code> property.
            /// </summary>
            const std::string EllipsoidPropertyName = "ellipsoid";

            /// <summary>
            /// The name of the <code>viewFrom</code> property.
            /// </summary>
            const std::string ViewFromPropertyName = "viewFrom";

            /// <summary>
            /// The name of the <code>model</code> property.
            /// </summary>
            const std::string ModelPropertyName = "model";

            /// <summary>
            /// The name of the <code>ellipse</code> property.
            /// </summary>
            const std::string EllipsePropertyName = "ellipse";

            /// <summary>
            /// The name of the <code>clock</code> property.
            /// </summary>
            const std::string ClockPropertyName = "clock";

            /// <summary>
            /// The name of the <code>version</code> property.
            /// </summary>
            const std::string VersionPropertyName = "version";

            /// <summary>
            /// The name of the <code>agi_conicSensor</code> property.
            /// </summary>
            const std::string ConicSensorPropertyName = "agi_conicSensor";

            /// <summary>
            /// The name of the <code>agi_customPatternSensor</code> property.
            /// </summary>
            const std::string CustomPatternSensorPropertyName = "agi_customPatternSensor";

            /// <summary>
            /// The name of the <code>agi_fan</code> property.
            /// </summary>
            const std::string FanPropertyName = "agi_fan";

            /// <summary>
            /// The name of the <code>agi_rectangularSensor</code> property.
            /// </summary>
            const std::string RectangularSensorPropertyName = "agi_rectangularSensor";

            /// <summary>
            /// The name of the <code>agi_vector</code> property.
            /// </summary>
            const std::string VectorPropertyName = "agi_vector";

        private:
            const StringCesiumWriter m_description = StringCesiumWriter(DescriptionPropertyName);
            const PositionCesiumWriter m_position = PositionCesiumWriter(PositionPropertyName);
            const BillboardCesiumWriter m_billboard = BillboardCesiumWriter(BillboardPropertyName);
            const OrientationCesiumWriter m_orientation = OrientationCesiumWriter(OrientationPropertyName);
            const PointCesiumWriter m_point = PointCesiumWriter(PointPropertyName);
            const LabelCesiumWriter m_label = LabelCesiumWriter(LabelPropertyName);
            const PolylineCesiumWriter m_polyline = PolylineCesiumWriter(PolylinePropertyName);
            const PathCesiumWriter m_path = PathCesiumWriter(PathPropertyName);
            const PolygonCesiumWriter m_polygon = PolygonCesiumWriter(PolygonPropertyName);
            const EllipsoidCesiumWriter m_ellipsoid = EllipsoidCesiumWriter(EllipsoidPropertyName);
            const ModelCesiumWriter m_model = ModelCesiumWriter(ModelPropertyName);
            const EllipseCesiumWriter m_ellipse = EllipseCesiumWriter(EllipsePropertyName);
            const ClockCesiumWriter m_clock = ClockCesiumWriter(ClockPropertyName);
            const ConicSensorCesiumWriter m_agi_conicSensor = ConicSensorCesiumWriter(ConicSensorPropertyName);
            const CustomPatternSensorCesiumWriter m_agi_customPatternSensor = CustomPatternSensorCesiumWriter(CustomPatternSensorPropertyName);
            const FanCesiumWriter m_agi_fan = FanCesiumWriter(FanPropertyName);
            const RectangularSensorCesiumWriter m_agi_rectangularSensor = RectangularSensorCesiumWriter(RectangularSensorPropertyName);
            const VectorCesiumWriter m_agi_vector = VectorCesiumWriter(VectorPropertyName);
