...
namespace CesiumLanguageWriter
{
    ...
    /// </summary>
    class AlignedAxisCesiumWriter : CesiumInterpolatablePropertyWriter<AlignedAxisCesiumWriter>
    {
        public:
            /// <summary>
        ...
        public:
            ...
            /// </summary>
            AlignedAxisCesiumWriter(string propertyName)
                : base(propertyName)
            {
            ...
            AlignedAxisCesiumWriter(const AlignedAxisCesiumWriter& existingInstance)
