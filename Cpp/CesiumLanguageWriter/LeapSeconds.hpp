...
namespace CesiumLanguageWriter
{
	...
	class LeapSeconds
	{
		...
		/// </summary>
		static std::shared_ptr<LeapSeconds> Instance()
		{
			return s_leapSeconds;
		}

		static void Instance(std::shared_ptr<LeapSeconds> leapSeconds)
		{
			s_leapSeconds = leapSeconds;
		}
		...
		LeapSeconds()
		{
			m_leapSeconds.push_back(LeapSecond(2441317.5, 10));
			m_leapSeconds.push_back(LeapSecond(2441499.5, 11));
			m_leapSeconds.push_back(LeapSecond(2441683.5, 12));
			m_leapSeconds.push_back(LeapSecond(2442048.5, 13));
			m_leapSeconds.push_back(LeapSecond(2442413.5, 14));
			m_leapSeconds.push_back(LeapSecond(2442778.5, 15));
			m_leapSeconds.push_back(LeapSecond(2443144.5, 16));
			m_leapSeconds.push_back(LeapSecond(2443509.5, 17));
			m_leapSeconds.push_back(LeapSecond(2443874.5, 18));
			m_leapSeconds.push_back(LeapSecond(2444239.5, 19));
			m_leapSeconds.push_back(LeapSecond(2444786.5, 20));
			m_leapSeconds.push_back(LeapSecond(2445151.5, 21));
			m_leapSeconds.push_back(LeapSecond(2445516.5, 22));
			m_leapSeconds.push_back(LeapSecond(2446247.5, 23));
			m_leapSeconds.push_back(LeapSecond(2447161.5, 24));
			m_leapSeconds.push_back(LeapSecond(2447892.5, 25));
			m_leapSeconds.push_back(LeapSecond(2448257.5, 26));
			m_leapSeconds.push_back(LeapSecond(2448804.5, 27));
			m_leapSeconds.push_back(LeapSecond(2449169.5, 28));
			m_leapSeconds.push_back(LeapSecond(2449534.5, 29));
			m_leapSeconds.push_back(LeapSecond(2450083.5, 30));
			m_leapSeconds.push_back(LeapSecond(2450630.5, 31));
			m_leapSeconds.push_back(LeapSecond(2451179.5, 32));
			m_leapSeconds.push_back(LeapSecond(2453736.5, 33));
			m_leapSeconds.push_back(LeapSecond(2454832.5, 34));
			m_leapSeconds.push_back(LeapSecond(2456109.5, 35));
		}
		...
		LeapSeconds(const std::vector<LeapSecond>& leapSeconds)
		{
			m_leapSeconds = leapSeconds;
			std::sort(leapSeconds.begin, leapSeconds.end, CompareLeapSecondDate);
		}

		/// <summary>
		/// Gets the list of leap seconds currently being used by this class.
		/// </summary>
		const std::vector<LeapSecond>& LeapSecondList()
		{
		...
		double GetTaiMinusUtc(JulianDate date)
		{
			LeapSecond toFind(date, 0.0);
	...
	private:
		...
		static bool CompareLeapSecondDate(const LeapSecond& x, const LeapSecond& y)
		{
			return x.Date.CompareTo(y.Date) == -1;
		}

		static std::shared_ptr<LeapSeconds> s_leapSeconds = std::make_shared<LeapSeconds>();
		std::vector<LeapSecond> m_leapSeconds;
	};
}